...
void paybill(void) {}
int doinvbill(int mode) { return(0); }
void shkdead(struct monst *mtmp) {}
int shkcatch(struct obj *obj) { return(0); }
int shk_move(struct monst *shkp) { return(0); }
void replshk(struct monst *mtmp, struct monst *mtmp2) {}
char *shkname(struct monst *mtmp) { return(""); }

...
static schar shprobs[] = { 3,3,5,5,10,10,14,50 };	/* their probabilities */

static struct permonst *morguemon(void);
static int nexttodoor(int sx, int sy);
static int has_dnstairs(struct mkroom *sroom);
static int has_upstairs(struct mkroom *sroom);
static int isbig(struct mkroom *sroom);
